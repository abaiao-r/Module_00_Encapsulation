...
/*   Updated: 2024/07/17 11:36:06 by andrefranci      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
Graph::Vector2::Vector2(float xCoord, float yCoord) : x(xCoord), y(yCoord)
{
}
 ...
 */
Graph::Vector2::Vector2(const Vector2 &other)
{
    *this = other;
}
 ...
 */
Graph::Vector2 &Graph::Vector2::operator=(const Vector2 &other)
{
    if (this != &other)
    {
        this->x = other.x;
 ...
 */
const float &Graph::Vector2::getX(void) const
{
    return (this->x);
}
 ...
 */
const float &Graph::Vector2::getY(void) const
{
    return (this->y);
}
 ...
 */
void Graph::Vector2::setX(float xCoord)
{
    this->x = xCoord;
}
 ...
 */
void Graph::Vector2::setY(float yCoord)
{
    this->y = yCoord;
}
